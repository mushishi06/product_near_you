  ...
  */
  ...
  var Searcher = function(prefs) {
    ...
    this.search = function(cb) {
      console.log("position ", this.prefs.position)
      console.log("lat ", this.prefs.position.lat)
      console.log("lng ", this.prefs.position.lng)
      var url = 'http://127.0.0.1:5000/search/'
      var data = {'limit':this.prefs.count, 'radius':this.prefs.radius, 'lat':this.prefs.position.lat, 'lng':this.prefs.position.lng}
